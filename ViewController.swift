...
//  Quiz
//
//  Created by FredKopeika on 07/11/15.
...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
     ...
     let q0answer1 = Answer(answer: "80 anos", isCorrect: true)
     let q0answer2 = Answer(answer: "140 anos", isCorrect: true)
    ...
    func selectAnswer(Answerid : Int){
        ...
        var answer : Answer = questions[currentQuestion].answers[Answerid] // seleciona resposta
